...
def student_quarters():
    try:
        ...
        if request.method == 'POST':
            ...
            if not first_name or not last_name or not email or not phone_number:
                ...
                return render_template('admin_templates/student_quarters.html',
                                       ...
                                       phone_number=phone_number, page=page, per_page=per_page,
        ...
        return render_template('admin_templates/student_quarters.html',
                               alert=alert, bg_color=bg_color,
                               student_quarters=True, all_students=all_students,
                               page=page, per_page=per_page, total_pages=total_pages, total_items=total_items)
        ...
        if request.method == "POST":
            ...
            if not course_unit or not course_code or not course_title:
                ...
                return render_template('admin_templates/courses.html',
                                       ...
                                       all_courses=all_courses, total_pages=total_pages, total_items=total_items,
                                       page=page, per_page=per_page)
